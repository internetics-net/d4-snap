...
This project is indexed by GitNexus as **d4-snap** (1826 symbols, 4202 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
